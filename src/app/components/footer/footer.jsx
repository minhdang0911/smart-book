...
import { Button, Col, Divider, Layout, Modal, Row, Select, Space, message } from 'antd';
        ...
        return (
            <div
                ...
                style={{
                    ...
                    backgroundColor: isOdd ? 'rgba(64, 169, 255, 0.3)' : 'rgba(24, 144, 255, 0.3)',
            ...
            <Footer ref={footerRef} style={footerStyles.footer}>
                <div style={footerStyles.container}>
                    ...
                    <Row gutter={[32, 32]}>
                        ...
                        <Col xs={24} sm={12} md={6}>
                            <div ref={addRefToSection} style={footerStyles.section}>
                                ...
                                <p style={footerStyles.description}>
                                    Nền tảng đọc sách trực tuyến hàng đầu Việt Nam, mang đến trải nghiệm đọc sách tuyệt
                                    vời với kho tàng tri thức phong phú.
                                </p>
                        ...
                        <Col xs={24} sm={12} md={6}>
                            <div ref={addRefToSection} style={footerStyles.section}>
                                ...
                                <ul style={footerStyles.linkList}>
                                    {['Trang chủ', 'Sách', 'Thể loại', 'Tác giả', 'Giới thiệu', 'Liên hệ'].map(
                                        (item, index) => (
                                            <li key={index}>
                                                {item === 'Liên hệ' ? (
                                                    <a
                        ...
                        <Col xs={24} sm={12} md={6}>
                            <div ref={addRefToSection} style={footerStyles.section}>
                                ...
                                <ul style={footerStyles.linkList}>
                                    {['Đọc online', 'Tải xuống', 'Audiobook', 'Gói premium', 'Hỗ trợ'].map(
                                        (item, index) => (
                                            <li key={index}>
                                                <a href="#" style={footerStyles.link} className="footer-link">
                                                    {item}
                    ...
                    <Row justify="space-between" align="middle" style={footerStyles.bottomFooter}>
                        <Col xs={24} md={12}>
                            <p style={footerStyles.copyright}>© 2024 SmartBook. Tất cả quyền được bảo lưu.</p>
                        </Col>
                        <Col xs={24} md={12}>
            ...
            >
                <div style={{ marginBottom: '16px' }}>
                    <Row gutter={16} align="middle">
                        ...
                        <Col span={12}>
                            <Button type="primary" onClick={handleGetDirections} block>
                                Chỉ đường tới đây
                            </Button>
                        </Col>
                    </Row>
                ...
                <div style={{ marginTop: '16px', padding: '12px', backgroundColor: '#f5f5f5', borderRadius: '6px' }}>
                    <h4 style={{ margin: '0 0 8px 0', color: '#001529' }}>{locations[selectedLocation].name}</h4>
                    <p style={{ margin: '0 0 4px 0', fontSize: '14px' }}>📍 {locations[selectedLocation].address}</p>
